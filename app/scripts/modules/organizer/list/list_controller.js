define(["app", "modules/organizer/list/list_view"], function(AppManager, View){
    AppManager.module("Organizer.List", function(List, AppManager, Backbone, Marionette, $, _){
        List.Controller = {
            ...
            sendMessage: function (text, col) {
                var userInfo = AppManager.request('get:user:info');
                var message = AppManager.request('chat:entity:new');
                message.set('msg', text);
    ...
    return AppManager.Organizer.List.Controller;
});
