...
db.once('open', function callback () {
    ...
    var bcrypt        =  require('bcrypt-nodejs'),
        userSchema    =  require('./models/userSchema')(mongoose, bcrypt),
    ...
    var companyModel  =  require('./models/company')(mongoose, userSchema),
        companies     =  require('./modules/companies')(mailer, companyModel, userModel);
